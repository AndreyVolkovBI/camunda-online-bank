...
@Component
public class ScoringServiceDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        delegateExecution.setVariable(GlobalConst.IS_VIP_OFFER_FIELD, isVipOffer);
    }
}
